...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | Deebian🥝")[0];
}
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Deebian🥝 %c 你正在访问Deebian🥝の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Deebian🥝") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Deebian🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
if ((y == 2025 && m == 4 && dd == 4) || (y == 2026 && m == 4 && dd == 5) || (y == 2025 && m == 4 && dd == 4)) {//清明节
  if (sessionStorage.getItem("isPopupWindow") != "1") {
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://pub-ae690ab9eccb40b091cbbc82a3d25155.r2.dev/F%E5%B0%8F%E5%B1%8B-%E7%A7%91%E7%A0%94%E6%91%B8%E9%B1%BC%E4%B8%AD.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i></div>`
      : `<img class='boardsign' src='https://pub-ae690ab9eccb40b091cbbc82a3d25155.r2.dev/F%E5%B0%8F%E5%B1%8B-%E4%B8%8B%E7%8F%AD%E4%BC%91%E6%81%AF%E5%95%A6.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i></div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://pub-ae690ab9eccb40b091cbbc82a3d25155.r2.dev/181750LAK1m.webp);
    --darkmode-bg:url(https://pub-ae690ab9eccb40b091cbbc82a3d25155.r2.dev/103206bBYEV.webp);
    --mobileday-bg: url(https://pub-ae690ab9eccb40b091cbbc82a3d25155.r2.dev/194348jgLB5.webp);
    --mobilenight-bg: url(https://pub-ae690ab9eccb40b091cbbc82a3d25155.r2.dev/010012iWwRS.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
